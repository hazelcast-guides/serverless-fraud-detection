...
. Open the Hazelcast {hazelcast-cloud} console, click *Connect Client*, and download the keystore files from the *Advanced Setup* tab.
...
. Open the Hazelcast {hazelcast-cloud} console, click *Connect Client*, and go to the *Advanced setup* tab. Leave this window open. You'll need some of these details in the next step.
